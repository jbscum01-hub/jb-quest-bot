...
const CONFIG = {
  ...
  settings: {
    ...
    maxTeamSizeDefault: 4,
    cooldownType: 'once_per_team',
    abandonedCountsAsCancel: true,
  },
  ...
  antiLeak: {
    hideOtherProfessionClues: true,
    restrictTicketViewToTeam: true,
    deleteSensitiveMessages: false,
